<template>
  <div class="flex justify-between">
    <h1 class="text-4xl font-black text-gray-800">Cadastre-se</h1>
  ...
  <div class="mt-10">
    <form @submit.prevent="handleSubmit">
      ...
      >
        ...
        <span v-else> Cadastrar e logar</span>
      </button>
    </form>
  </div>
</template>
    ...
    async function handleSubmit () {
      try {
        ...
        if (errors.status === 400) {
          toast.error('Ocorreu um erro ao fazer cadastro')
        }
